...
export function FloatingWhatsApp() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 flex flex-col items-end pointer-events-none select-none">
      ...
      <AnimatePresence>
        {!hasDismissedTooltip && (
          <motion.div
            ...
            className="pointer-events-auto mb-3 max-w-xs p-3.5 rounded-2xl bg-obsidian-900/90 border border-rosegold-300/30 shadow-2xl backdrop-blur-xl text-white text-xs flex items-start gap-2.5"
          >
            <div className="p-1.5 rounded-full bg-rosegold-400/20 text-rosegold-200 shrink-0">
              <Sparkles className="w-3.5 h-3.5" />
            </div>
            <div className="flex-1">
              <p className="font-medium text-rosegold-200">¿Dudas con tu rutina?</p>
      ...
      <a
        href="https://wa.me/5491123923931?text=Hola%20Glow%20Girls!%20Quisiera%20asesoramiento%20personalizado"
        target="_blank"

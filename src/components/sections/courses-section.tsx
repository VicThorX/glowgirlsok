...
export function CoursesSection() {
  ...
  const toggleModule = (number: string) => {
    setExpandedModule(expandedModule === number ? null : number);
  };
    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14 sm:mb-20">
          ...
          >
            <GraduationCap className="w-3.5 h-3.5 text-gold-300" />
            <span>Capacitación Virtual · Academia Glow</span>
          </motion.div>
          ...
          >
            Cursos Virtuales & Capacitación Profesional
          </motion.h2>
          ...
          >
            Aprende a formular y diagnosticar con cosmética botánica de alta gama.
            Formación 100% online diseñada para emprender o perfeccionar tu técnica con{" "}
            <strong className="text-gold-200 font-semibold">acompañamiento personalizado gratuito</strong>.
          </motion.p>
        </div>

        {/* Course Main Showcase Card */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-start">
          ...
          <div className="lg:col-span-6 flex flex-col gap-6">
            <SpotlightCard className="p-6 sm:p-8 border border-gold-400/30 hover:border-gold-300/60 bg-gradient-to-b from-obsidian-850/80 to-obsidian-900/95 shadow-glow-gold-card">
              ...
              {/* Course Title & Price */}
              <div className="mb-5">
                <h3 className="font-serif text-2xl sm:text-3xl font-medium text-white mb-2 leading-tight">
                  {course.title}
                </h3>
              ...
              {/* Free Mentorship Highlight Banner */}
              <div className="p-4 rounded-2xl bg-gradient-to-r from-gold-500/15 via-gold-400/10 to-amber-500/15 border border-gold-400/40 mb-6 flex items-start gap-3 shadow-glow-subtle">
                ...
                <div>
                  <h4 className="font-serif text-white text-sm font-semibold mb-0.5">
                    Beneficio Exclusivo: Acompañamiento Gratuito
                  </h4>
                  <p className="text-xs text-pearl-300 leading-relaxed">
                    No aprendés sola. Cuentas con seguimiento directo y mentoría 1-a-1 vía WhatsApp para responder consultas sobre tus fórmulas y rutinas.
                  </p>
                </div>
              </div>

              {/* What is included checkmarks */}
          ...
          {/* Right Column: Modular Syllabus Accordion */}
          <div className="lg:col-span-6 flex flex-col gap-5">
            ...
            <p className="text-xs sm:text-sm text-pearl-300 leading-relaxed">
              Haz clic en cada módulo para desplegar los contenidos y temas prácticos que aprenderás durante la formación:
            </p>
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <span className="text-[10px] uppercase tracking-widest text-pearl-400 block mb-0.5">
                            {mod.duration}
                          </span>
                      ...
                      <div
                        className={`p-2 rounded-full border border-gold-400/20 text-gold-300 transition-transform duration-300 ${
                    ...
                    <AnimatePresence>
                      {isExpanded && (
                        ...
                        >
                          <div className="px-5 sm:px-6 pb-6 pt-1 border-t border-gold-400/15">
            ...
            <div className="p-5 rounded-2xl bg-white/[0.02] border border-gold-400/15 flex items-center justify-between gap-4 mt-2">
              <div className="flex items-center gap-3">
                <div className="p-2.5 rounded-xl bg-gold-400/10 text-gold-300">
                  <Award className="w-5 h-5" />
                </div>
                <div>
                  <h5 className="font-serif text-white text-sm font-medium">¿Tenés dudas sobre el curso?</h5>
                  <p className="text-xs text-pearl-400">Escribinos y una asesora te guiará sobre el temario</p>
                </div>
              </div>
              <a
                href={whatsappUrl}
                ...
                className="shrink-0"
              >
                <MagneticButton variant="secondary" className="text-xs uppercase tracking-wider py-2.5 px-4">
                  <span>Preguntar</span>
                </MagneticButton>
              </a>
            </div>
